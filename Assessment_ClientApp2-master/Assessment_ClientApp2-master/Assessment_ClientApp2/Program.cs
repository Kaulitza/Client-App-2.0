...
namespace Assessment_ClientApp2
{
    ...
    class Program
    {
        ...
        static List<Monster> InitializeMonsterList()
        {
            ...
            List<Monster> monsters = new List<Monster>()
            {
                ...
                new Monster()
                {
                    ...
                    Color = "red",
                    Country = "USA",
                    Tribes = Monster.Tribe.Targaryans,
                    Active = true
                },
                ...
                new Monster()
                {
                    ...
                    Color = "yellow",
                    Country = "France",
                    Tribes = Monster.Tribe.Unsullied,
                    Active = true
                },
                ...
                new Monster()
                {
                    ...
                    Color = "green",
                    Country = "Germany",
                    Tribes = Monster.Tribe.Lannisters,
                    Active = true
                },
                 new Monster()
                {
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            Console.Write("\tColor: ");
            newMonster.Color = Console.ReadLine();
            Console.Write("\tCountry: ");
            newMonster.Country = Console.ReadLine();
            ...
            do
            {
                ...
                if (tribe != Monster.Tribe.None)
                {
                    newMonster.Tribes = tribe;
                    validResponse = true;
                }
                else
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("\tPlease select a valid tribe.");
                    Console.WriteLine();
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            Console.WriteLine();
            Console.Write($"\tCurrent Color: {selectedMonster.Color} \tNew Color: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {

                selectedMonster.Color = userResponse;
            }
            Console.WriteLine();
            Console.Write($"\tCurrent Country: {selectedMonster.Country} \tNew Country: ");
            userResponse = Console.ReadLine();
            selectedMonster.Country = userResponse;
            do
            {
                validResponse = false;
                Console.WriteLine();
            ...
            else if (userResponse == "Not Active")
            {
                selectedMonster.Active = false;
            }
            else
            {
                Console.WriteLine("Please select active or not active.");
                DisplayContinuePrompt();
                userResponse = Console.ReadLine();
                if (userResponse == "yes")
                { selectedMonster.Active = true; }
        ...
        static void MonsterInfo(Monster monster)
        {
            ...
            Console.WriteLine($"\tCountry: {monster.Country}");
            ...
            else if (monster.Active == false)
            {
                Console.WriteLine($"\tStatus: Not active");
            }
